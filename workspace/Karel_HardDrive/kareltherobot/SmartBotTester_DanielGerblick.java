...
public class SmartBotTester_DanielGerblick implements Directions
{
	public static void main(String args[])  
	{
		World.setVisible(true);
		World.showSpeedControl(true);
		World.readWorld("worldFiles\\smartbotWorld.txt");
		World.readWorld("smartbotWorld.txt");

	   	// There is NO beeper to the left, so robot should not turn off
		SmartBot_DanielGerblick einstein = new SmartBot_DanielGerblick(2, 2, North, 0);		
		...
		einstein = new SmartBot_DanielGerblick(2, 4, North, 0);
		if (!einstein.beeperIsToLeft())
		{
			einstein.turnOff();
		}
		...
		einstein = new SmartBot_DanielGerblick(3, 4, North, 0);
		...
		einstein = new SmartBot_DanielGerblick(3, 6, North, 0);
		if (einstein.beeperIsToRight())
		{
			einstein.turnOff();
		}
		...
		einstein = new SmartBot_DanielGerblick(2, 7, North, 0);
		...
		einstein = new SmartBot_DanielGerblick(2, 8, North, 0);
		if (!einstein.twoBeepersOrMoreOnCorner())
		{
			einstein.turnOff();
		}
		...
		einstein = new SmartBot_DanielGerblick(2, 9, North, 0);
		if (!einstein.twoBeepersOrMoreOnCorner())
		{
			einstein.turnOff();
		}
		...
		einstein = new SmartBot_DanielGerblick(6, 2, East, 0);
		einstein.faceNorth();
		...
		einstein = new SmartBot_DanielGerblick(6, 4, North, 0);
		einstein.faceWest();
		...
		einstein = new SmartBot_DanielGerblick(6, 6, North, 0);
		einstein.faceSouth();
		...
		einstein = new SmartBot_DanielGerblick(6, 8, North, 0);
		einstein.faceEast();
